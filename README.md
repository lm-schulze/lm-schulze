...
- [**Learning the topology of a Bayesian Network from a database of cases using the K2 algorithm**](https://github.com/lm-schulze/bayesian_networks): Final project of the course *Advanced Statistics*. Implementation of the K2-algorithm to construct Bayesian belief-networks from records, and application to 3 small test datasets and one real-world dataset.
